...
inicio:
	ld		bc, titulo					// BC aponta para mensagem de titulo
a4:
	ld		d, DELAYROL					// D contem um contador de atraso para rolagem do titulo
	inc		bc							// incrementa BC
	ld		a, c						// testa C
	cp		LOW (titulo+22)				// se for fim da mensagem
	jp z, 	inicio						// recomeca tudo
a3:
...
perdeu:
	ld		bc, mens_gameover
a18:
	ld		d, DELAYROL					// atraso de rolagem de mensagem
	inc		bc
	ld		a, c
	cp		LOW (mens_gameover + 16)
	jp z,	perdeu
a17:
	ld		h, b
	ld		l, c
...
mens_gameover:
	...
	db		DIG_L, DIG_E
	db		DIG_APAG, DIG_APAG
	db		DIG_D, DIG_A, DIG_N, DIG_C, DIG_E
	db		DIG_APAG, DIG_APAG, DIG_APAG, DIG_APAG, DIG_APAG, DIG_APAG
